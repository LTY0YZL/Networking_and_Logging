...
namespace Communications
{
    public class Networking : INetworking
    {
        ...
        private ReportConnectionEstablished _onConnect;
        private ReportDisconnect _onDisconnect;
        private ReportMessageArrived _onMessage;
        private string _lastKnownRemoteEndPoint;
        ...
        {
            if (string.IsNullOrEmpty(id) && _tcpClient?.Client?.RemoteEndPoint != null)
            {
        ...
        public string RemoteAddressPort
        {
            get { 
                ...
                {
                    return $"Waiting For Connections On Port: {_tcpListener.LocalEndpoint}";
                }
                else
                {
                    return "Disconnected";
        ...
        /// </param>
        public Task HandleIncomingDataAsync(bool infinite)
        {
        ...
        public Task WaitForClientsAsync(int port, bool infinite)
        {
            throw new NotImplementedException();
        }
